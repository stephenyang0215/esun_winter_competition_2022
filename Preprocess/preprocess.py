...
def train_alert_process_func(data, custinfo, train_alert_time, predict_alert_time):
...
#dp zone
train_dp, alert_dp = train_alert_process_func(dp, custinfo,train_alert_time, predict_alert_time)
